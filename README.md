...
| Leaderboard | Community timeline |
|:---:|:---:|
| <img src="docs/ui-board.png" width="280" alt="Leaderboard screen" /> | <img src="docs/ui-timeline.png" width="280" alt="Community timeline screen" /> |

*Live screenshots of the actual app. Online count, green presence dots, and the
`date · HH:MM · relative` timestamps are all rendered straight from the server state.*
